...
const BottomNav = () => {
  return (
    <nav className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[448px] h-16 bg-white border-t border-gray-100 shadow-lg flex items-center justify-around z-50">
      <NavLink
        to="/dashboard"
        className={({ isActive }) =>
