...
const translationDictionary = {
  ...
  "groundnut": "मूंगफली", "peanut": "मूंगफली", "peanuts": "मूंगफली", "chickpea": "चना",
  "lentil": "मसूर", "sunflower": "सूरजमुखी", "sunflowers": "सूरजमुखी",
  "barley": "जौ", "mustard": "सरसों", "potatoes": "आलू", "blueberries": "ब्लूबेरी",
  "pepper": "शिमला मिर्च", "pepper, bell": "शिमला मिर्च", "apple": "सेब",
  "cherry": "चेरी", "grape": "अंगूर", "peach": "आड़ू", "raspberry": "रसभरी",
  "squash": "कद्दू", "strawberry": "स्ट्रॉबेरी", "sweet potato": "शकरकंद",
  "sweet potatoes": "शकरकंद", "cucumber": "खीरा",
  ...
  "tomato leaf mold": "टमाटर का पत्ता मोल्ड रोग",
  "tomato bacterial spot": "टमाटर का जीवाणु धब्बा रोग",
  "tomato septoria leaf spot": "टमाटर का सेप्टोरिया पत्ता धब्बा रोग",
  "tomato spider mites two spotted spider mite": "टमाटर का लाल मकड़ी रोग",
  "tomato target spot": "टमाटर का टार्गेट स्पॉट रोग",
  "tomato yellow leaf curl virus": "टमाटर का पीला पत्ता मुड़न वायरस रोग",
  "tomato mosaic virus": "टमाटर का मोज़ेक वायरस रोग",
  "wheat healthy": "स्वस्थ गेहूं",
  "wheat rust": "गेहूं का रतुआ रोग",
  "corn healthy": "स्वस्थ मक्का",
  "corn blight": "मक्का का झुलसा रोग",
  "corn cercospora leaf spot": "मक्के का सर्कोस्पोरा पत्ता धब्बा रोग",
  "corn common rust": "मक्के का सामान्य रतुआ रोग",
  "corn northern leaf blight": "मक्के का उत्तरी पत्ता झुलसा रोग",
  "pepper, bell bacterial spot": "शिमला मिर्च का जीवाणु धब्बा रोग",
  "pepper, bell healthy": "स्वस्थ शिमला मिर्च",
  "apple scab": "सेब का पपड़ी रोग",
  "apple black rot": "सेब का काला सड़न रोग",
  "apple cedar rust": "सेब का देवदार रतुआ रोग",
  "apple healthy": "स्वस्थ सेब",
  "blueberry healthy": "स्वस्थ ब्लूबेरी",
  "cherry powdery mildew": "चेरी का चूर्णिल आसिता (Mildew) रोग",
  "cherry healthy": "स्वस्थ चेरी",
  "grape black rot": "अंगूर का काला सड़न रोग",
  "grape esca black measles": "अंगूर का एस्का रोग",
  "grape leaf blight isariopsis leaf spot": "अंगूर का इसारियोप्सिस पत्ता धब्बा रोग",
  "grape healthy": "स्वस्थ अंगूर",
  "orange huanglongbing citrus greening": "संतरे का सिट्रस ग्रीनिंग रोग",
  "peach bacterial spot": "आड़ू का जीवाणु धब्बा रोग",
  "peach healthy": "स्वस्थ आड़ू",
  "raspberry healthy": "स्वस्थ रसभरी",
  "soybean healthy": "स्वस्थ सोयाबीन",
  "squash powdery mildew": "कद्दू का चूर्णिल आसिता (Mildew) रोग",
  "strawberry leaf scorch": "स्ट्रॉबेरी का पत्ती झुलस रोग",
  "strawberry healthy": "स्वस्थ स्ट्रॉबेरी",
